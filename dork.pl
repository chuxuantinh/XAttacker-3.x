...
print color('bold red'),"] ";
print color('bold white'),"Mass Grab Zone-h |> Starts A Private Tool That Gathers Zone-h Arcs\n";;
print color('bold red'),"[";
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color("bold white"),"[Starting Zone Grabber]\n";
sleep(5);
system("python ZoneKiller.py");
}
...
$url = "http://www.bing.com/search?q=$dork";
...
$link = $1;
        if ( $link !~ /overture|msn|live|bing|yahoo|duckduckgo|google|yahoo|microsof|Ask|wiki|gibiru|yandex/)
        {
